...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    monthName: "January",
    dayCount: 122,
    message: "Starting 2026 with you by my side brought a different kind of warmth to the winter. It was a month of new beginnings, not just for the year, but for a new age. As we brought our friends into our shared world and the circles around us grew, our own center stayed just as quiet. In the middle of it all, I found a way to show you that we could make it if we try, just the two of us.",
  ...
  },
  {
    ...
    monthName: "March",
    dayCount: 181,
    message: "March brought the end of the long road, finally closing the distance that had felt so wide just a month before. Returning to the warmth of being together was a relief that words could barely reach, an exhale that made the world feel small and safe again. It was a month of widening circles, where I began to see your reflection in the eyes of those who raised you and found my own place within the stories that shaped you. In the quiet of being home again, the world finally felt whole.",
